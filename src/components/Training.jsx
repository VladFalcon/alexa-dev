            ...
            <div className="max-w-5xl mx-auto px-4 text-center space-y-8 relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-condensed font-black uppercase tracking-widest text-white mb-4">
                        Train with the Vice-World Champion
                    </h2>
                    <div className="h-1.5 w-24 bg-red-600 mx-auto mb-8"></div>
                    <p className="text-zinc-400 text-lg max-w-2xl mx-auto leading-relaxed">
                        Premium specialized firearms coaching for highly motivated competitors. Athlete onboarding is strictly capped to focus heavily on custom performance metrics.
                    </p>
                </motion.div>
                ...
                >
                    {[
                        { title: "Individual Coaching", desc: "Elite personalized track configurations built for your dynamic classification goals." },
                        { title: "Advanced Training Camps", desc: "Intensive performance immersion workshops tracking match mechanics under extreme strain." },
                        { title: "Match Preparation", desc: "Deconstruct match logistics, psych-conditioning, and mechanical management protocols." },
                        { title: "Biomechanical Online Analysis", desc: "Remote advanced video frame analysis break down of balance, transitions, and speed metrics." }
                    ].map((item, index) => (
